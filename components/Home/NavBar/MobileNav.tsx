...
const MobileNav = ({closeNav, showNav}:Props) => {
  ...
  return (
    <div>
      ...
      <div className={`${navOpen} text-white fixed justify-center flex flex-col h-full transform transition-all duration-500 delay-300 w-[80%] sm:[60%] bg-pink-600 space-y-6 z-[1050]`}>
        {navLinks.map((link) => {
          return (
